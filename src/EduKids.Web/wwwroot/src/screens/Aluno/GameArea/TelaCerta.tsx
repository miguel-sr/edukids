...
import { View, Image, StyleSheet, Text, ImageBackground, TouchableOpacity, Pressable } from 'react-native';
...
import rigth from '../../../assets/assetsJogo/allright.png';
    ...
    <TouchableOpacity style={styles.container}  activeOpacity={1}>
      <View style={styles.container}>
        <View style={styles.background}>
          ...
          <Image source={rigth} style={styles.image} />
          <Image source={coin} style={[styles.coin, { top: 50, left: 20 }]} />
          <Image source={coin} style={[styles.coin, { top: 10, left: -20 }]} />
          <Image source={coin} style={[styles.coin, { top: -150, left: 20 }]} />
          <Image source={coin} style={[styles.coin, { top: 50, left: -160 }]} />
          <Image source={coin} style={[styles.coin, { top: 50, left: 200 }]} />
          <Image source={coin} style={[styles.coin, { top: 50, left: 400 }]} />
          <Image source={coin} style={[styles.coin, { top: 150, left: 300 }]} />
          <Image source={coin} style={[styles.coin, { top: -350, left: 400 }]} />
          <Image source={coin} style={[styles.coin, { top: -70, left: 400 }]} />
          <Image source={coin} style={[styles.coin, { top: -150, left: -300 }]} />
