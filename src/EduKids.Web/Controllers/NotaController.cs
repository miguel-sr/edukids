...
namespace EduKids.Web.Controllers
{
    ...
    [ApiController]
    public class NotaController(INotaRepositorio repositorio) : ControllerBase
    {
        private readonly ServicoDeNotas _servicoDeNotas = new(repositorio);
        ...
        public async Task<IActionResult> ObterTodos()
        {
            try
            {
                var notas = await _servicoDeNotas.ObterTodos();
        ...
        public async Task<IActionResult> ObterPorId(int id)
        {
            try
            {
                var nota = await _servicoDeNotas.ObterPorId(id);
        ...
        [HttpPost]
        [AllowAnonymous]
        public async Task<IActionResult> Criar([FromBody] Nota nota)
        {
            try
            {
                var notaDoBanco = await _servicoDeNotas.Adicionar(nota);
        ...
        [HttpPut]
        [AllowAnonymous]
        public async Task<IActionResult> Atualizar([FromBody] Nota nota)
        {
            try
            {
                await _servicoDeNotas.Atualizar(nota);
        ...
        public async Task<IActionResult> Remover(int id)
        {
            try
            {
                await _servicoDeNotas.Remover(id);
